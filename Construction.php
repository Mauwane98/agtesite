                     ...
                     <ul class="flex space-x-6 text-lg">
                        ...
                        <li class="relative nav-item-services">
                            ...
                            <ul class="absolute dropdown-menu dropdown-hidden mt-2 w-48 overflow-hidden">
                                ...
                                ?>
                                <li><a href="<?php echo htmlspecialchars($link_href); ?>" class="sub-nav-link <?php echo (strtolower($service['name']) == 'ppe') ? 'active' : ''; ?>"><?php echo htmlspecialchars($service['name']); ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </li>
    ...
    <div id="mobile-menu" class="text-white">
        <ul class="flex flex-col space-y-2 p-4 text-lg">
            ...
            foreach ($services as $service):
                ...
                $link_href = $service_pages[$service_name_lower] ?? 'service.php?name=' . urlencode($service_name_lower);
            ?>
            <li><a href="<?php echo htmlspecialchars($link_href); ?>" class="block py-2 px-4 rounded hover:bg-gray-700 <?php echo (strtolower($service['name']) == 'ppe') ? 'active' : ''; ?>"><?php echo htmlspecialchars($service['name']); ?></a></li>
            <?php endforeach; ?>
