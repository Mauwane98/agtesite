...
<head>
    <meta charset="utf-8">
    <title>AGTE - Always Good Trading Enterprise - Services</title>
...
<body class="bg-white">
    ...
    <main>
        ...
        <div class="relative text-center">
            <img src="images/<?php echo htmlspecialchars($site_images['hero_image'] ?? 'AGTE%20Head%20Img.jpg'); ?>" alt="AGTE Header Image" class="w-full h-64 md:h-80 object-cover" onerror="this.onerror=null;this.src='https://placehold.co/1070x357/cccccc/000000?text=Our+Services';">
            <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                <h1 class="text-white text-4xl md:text-6xl font-bold">Our Services</h1>
            </div>
        </div>
            ...
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div class="service-section">
                        ...
                        <a href="<?php echo htmlspecialchars($link_href); ?>" class="read-more-btn">Learn More</a>
                    </div>
                    <?php endforeach; ?>
                </div>
            </div>
